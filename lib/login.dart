                      ...
                      children: [
                        TextButton(
                          ...
                          onPressed: () {
                            ...
                            if(emailController.text == 'manshi@gmail.com' && passwordController.text == 'manshi'){
                             Navigator.push(
                              context,
                              ...
                              final snackBar = SnackBar(
                                ...
                                content: const Text('Email and Password is incorrect!', style: TextStyle(color: Colors.white, fontSize: 18),),
                  ...
                  children: [
                    ...
                    TextButton(
                        ...
                        onPressed: () {
                            Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => SignUp(emailController.text, passwordController.text)),
                          );
